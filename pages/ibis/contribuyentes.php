...
<div class="container mt-5 fondoEspecial">
    <div class="row justify-content-center">
        <div class="col-md-12 shadow-lg pb-3 mb-4 bg-body rounded">
            <h4>SELECCIONAR CONTRIBUYENTE PARA ASIGNACIÓN DE IBI y TA</h4>
            <div class="container">
                <div class="row justify-content-center">
                        ...
                        <table id='tablax' class="mt-2 mb-0 table table-dark table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="ibi.php?id=<?php echo urlencode($contribuyente['identificacion']); ?>" class="btn btn-outline-success bi bi-check"> Seleccionar</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
